...
<figure><img src=".gitbook/assets/MainPageWelcome.png" alt="The beginning of the introductory guide DM. The rest of the message continues explaining the introductory activities."><figcaption><p>The beginning of the introductory guide DM. The rest of the message continues explaining the introductory activities.</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/LogEditor.png" alt="A screenshot showing the modal to edit event types logged in a channel"><figcaption><p>The modal to edit logs. This will soon be replaced with an innovative system</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/MainPageMuterole.png" alt="A screenshot showing the result of the /create-muterole command"><figcaption><p>Result of the <code>/create-muterole</code> command</p></figcaption></figure>
...
<figure><img src=".gitbook/assets/EvasionBanLog.png" alt="A screenshot showing a log message recording a user getting banned for trying to evade a mute"><figcaption><p>A mute evasion ban being logged looks like this</p></figcaption></figure>
